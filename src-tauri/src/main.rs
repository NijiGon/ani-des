...
use downloads::{start_download, start_bulk_download, get_downloads, cancel_download, remove_download, open_download_folder, DownloadManager};
...
fn main() {
    ...
    rt.block_on(async {
        proxy::start_proxy(proxy_state.clone());
    });
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cancel_download, remove_download, open_download_folder,
